...
# summarise number of journals offering each PPPR type in each domain
sum_domain_type <- d_policy %>%
  count(domain, type = PPPR_name_harmonized, .drop = F) %>%
  filter(type %notin% c('Not categorised','Other'))

# summarise number of journals offering any PPPR type in each domain
